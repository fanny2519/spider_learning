...
class LianjiaSpider_fz(scrapy.Spider):
    name = "lianjia_fz"
    allowed_domains = ["fz.lianjia.com"]

    # start_urls = ["https://cd.lianjia.com/ershoufang/106115530736.html"]

    # 一级页面（一共一百页）
    def start_requests(self):
        for page in range(20, 101):
            yield scrapy.Request(url="https://fz.lianjia.com/ershoufang/pg" + str(page), callback=self.parse)
            time.sleep(1)
